...
public class Main {
    public static void main(String[]args) {
        String[]test1 = {"aa","bbc"}; //10
        char[] alphabet = AlphabetGenerator.generateFrequencyAlphabet(10,test1);
        System.out.println(Arrays.toString(alphabet));
        String[]test2 = {"a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z"};
        alphabet = AlphabetGenerator.generateFrequencyAlphabet(26,test2);
        System.out.println(Arrays.toString(alphabet));
        //26
        String[]test3 = {"a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z"};
        alphabet = AlphabetGenerator.generateFrequencyAlphabet(13,test3);
        System.out.println(Arrays.toString(alphabet));
        //13
        String[]test4 = {"a","b","c","d","e","f"};
        alphabet = AlphabetGenerator.generateFrequencyAlphabet(4,test4);
        System.out.println(Arrays.toString(alphabet));
        // 4
        String[]test5 = {"aAD*&a","b","&Zbc"};
        alphabet = AlphabetGenerator.generateFrequencyAlphabet(10,test5);
        System.out.println(Arrays.toString(alphabet));
        //10
        String[]test6 = {"a","b"};
        alphabet = AlphabetGenerator.generateFrequencyAlphabet(2,test6);
        System.out.println(Arrays.toString(alphabet));
        //2
        String[]test7 = {"aa","b"};
        alphabet = AlphabetGenerator.generateFrequencyAlphabet(3,test7);
        System.out.println(Arrays.toString(alphabet));
        //3
        String[]test8 = {"aa","bb"};
        alphabet = AlphabetGenerator.generateFrequencyAlphabet(4,test8);
        System.out.println(Arrays.toString(alphabet));
        //4
        String[]test9 = {"aa","bbd"};
        alphabet = AlphabetGenerator.generateFrequencyAlphabet(10,test9);
        System.out.println(Arrays.toString(alphabet));
        //10
        String[]test10 = {"ab","bbc"};
        alphabet = AlphabetGenerator.generateFrequencyAlphabet(10,test10);
        System.out.println(Arrays.toString(alphabet));
        //10
    }
//    public static final int PI_PRECISION = 10000;// 10000
//
